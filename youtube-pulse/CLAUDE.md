# youtube-pulse — Claude Code 진입 문서
...
**하네스 이름:** youtube-pulse

**목표:** 일본 유투건강습영상 생성 웹어플리케이션 개발

**트리거:** youtube-pulse, webapp 관련 작업 요청 시 `youtube-pulse-orchestrator` 스킬을 사용하라. 단순 질문은 직접 응답 가능.

**변경 이력:**

| 날짜 | 변경 내용 | 대상 | 사유 |
|------|----------|------|------|
| 2026-04-28 | 초기 구성 | 전체 | 하네스 신규 구축 |
